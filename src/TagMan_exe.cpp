...
//#include "q:\code\sqlite\include\sqlite3.h"
...
//#include <memory>
//#include <q:\code\ws\32\staff\include\staff\utils\Log.h>
//#include <q:\code\ws\32\staff\include\staff\common\logoperators.h>
//#include <q:\code\ws\32\staff\include\staff\common\Exception.h>
//#include <q:\code\ws\32\staff\include\staff\client\ServiceFactory.h>


#include "fileFunctions.h"

//#include <cstdlib>
//#include <Q:\code\libconfig-1.4.9\lib\libconfig.h++>
...
//end of fitline example
			...
			//TODO:use RANSAC on barcodes (part 4): detect barcodesize
				 ...
				 AppData a1;
				 a1.clientID.assign("3453633");
				 a1.clientKey.assign("43453459");

				a1.fileAddress.assign("sdfsdfsdf");
				 a1.filenameBase.assign("dfsdfsd");
				 a1.file="";
				 a1.filenameExt="";
				 a1.filenameRelative="";

				 coutdd(a1.clientID<<","<<a1.clientKey<<","<<a1.fileAddress<<endl);
				 AppData a2;
				 coutdd("serializing..."<<endl);
				 string s1=a1.Serialize();

				 coutdd("deserializing..."<<endl);
				 a2.Deserialize(s1);

				 coutdd("sample:"<<endl);

				 coutdd(a2.clientID<<" "<<a2.clientKey<<","<<a2.fileAddress);
