...
#ifndef _wsOCRWrapper_h_
#define _wsOCRWrapper_h_
...
namespace staff
{
  ...
  //! wsOCR service wrapper
  class wsOCRWrapper: public staff::ServiceWrapper
  {
  public:
    //! initializing constructor
    /*! \param  pComponent - service's component
    */
    wsOCRWrapper(staff::Component* pComponent);

    //! destructor
    virtual ~wsOCRWrapper();
